...
Reward.create(title: 'Thing1', description: 'Description1')
Reward.create(title: 'Thing2', description: 'Description2')
Reward.create(title: 'Thing3', description: 'Description3')
Reward.create(title: 'Thing4', description: 'Description4')
Reward.create(title: 'Thing5', description: 'Description5')
Reward.create(title: 'Thing6', description: 'Description6')
Reward.create(title: 'Thing7', description: 'Description7')
